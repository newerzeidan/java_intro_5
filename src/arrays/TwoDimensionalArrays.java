...
public class TwoDimensionalArrays {
    public static void main(String[] args) {
        ...
        System.out.println(students.length); // 3 -> outter array -> how many main groups or rows
        ...
        /*
        TASK
        Print each number into different lines
        Ali
        Mehmet
        Alex
        Alex
        ...
        Newer
         */
        // Printing each student with foreach
        for (String[] group : students) {
