...
public class Contains2Or3 {
    public static void main(String[] args) {
        ...
        /*
        Create a public static method which will generate 5 numbers between 1-10 both included
        then store all of them inside the arrayList and return true if it is containing
        "2" or "3".
    ...
    public static boolean contains7Or13(){
        ...
        for (int i = 0; i < 7; i++) {
            rando.add(RandomNumberGenerator.getARandomNumber(-20,20));
        }
        System.out.println(rando);
        return rando.contains (-20) || rando.contains(20);
