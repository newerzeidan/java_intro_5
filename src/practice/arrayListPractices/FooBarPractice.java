...
public class FooBarPractice {
    ...
    /*
    Create a public static method which will print numbers 1 to 10, and it will print "Lucky"
    if it is dividable by "3".
    ...
    public static void printLucky(){
       ...
       /* Create a public static void method which will print numbers from 1 to 10, and it
