...
public class Exercise5 {
    public static void main(String[] args) {
        ...
        System.out.println("Absolute of s1 and s2 = " + Math.abs(i1 - i2)); // 25
        ...
        System.out.println("Min of s1 and s2 = " + Math.min(i1 , i2)); // 10
        System.out.println("Max of s1 and s2 = " + Math.max(i1 , i2)); // 35
